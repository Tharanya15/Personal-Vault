...
import javax.swing.*;
public class Delete_an_Entry_Card extends JFrame 
{
JLabel l, l_username;
    JTextField t_username;
    JButton b_search,b_back;
      JComboBox combo;
    public Delete_an_Entry_Card(String username)
    {
        JFrame f=new JFrame();
        ...
        l_username=new JLabel("Select Card");
      ...
      // combo.setBackground(Color.black);
       ...
       combo.addItem("Select");
           try
                {
                    ...
                    String pass_man="_CardDetails";
                    String query="select * from "+username+pass_man;
                    ResultSet res=stmt.executeQuery(query);
                     while(res.next())
                       {
                            combo.addItem(res.getString("card_num"));
                       }
                    con.close();
                  }
                  catch(Exception ae)
        ...
        b_search.setBounds(220,250,200,40);
                ...
                {   int flag=0;
                    ...
                    while(rs.next())
                    {
                     //   String res=new encryption().decrypt(rs.getString("email"));
                        if(email.equals(rs.getString("card_num")))
                        {
                            flag=1;
                            break;
                        }
                  ...
                  {  JFrame f1=new JFrame();
                    ...
                    b_yes.addActionListener(new ActionListener()
                    {
                        ...
                        try{
                                ...
                                Statement st=con.createStatement();
                                String pass_man="_CardDetails";
                                String query="Delete from "+username+pass_man+" where card_num='"+email+"'";
